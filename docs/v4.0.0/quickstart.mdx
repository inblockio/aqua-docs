---
title: "Quick Start"
description: "This guide will get you up and running with Aqua Protocol quickly. You'll create your first Aqua chain, sign it, and optionally witness it on a blockchain."
icon: "rocket"
sidebar_position: 2
---
...
<Tabs defaultValue="js">
  <TabsList>
      <TabsTrigger value="js">JavaScript/TypeScript (v3)</TabsTrigger>
      <TabsTrigger value="rust">Rust (V4)</TabsTrigger>
  </TabsList>
