...
<Accordion type="single" collapsible>
  <AccordionItem title="Node.js: Module not found error" defaultOpen>
  ...
  <AccordionItem title="TypeScript: Type errors" defaultOpen>
  ...
  <AccordionItem title="Rust: Compilation errors" defaultOpen>
  ...
  <AccordionItem title="MetaMask: Not detecting in Node.js" defaultOpen>
  ...
  <AccordionItem title="Witnessing: Network errors" defaultOpen>
