...
Trusted third parties — universities, licensing boards, employers — can sign attestations that validate a user's specific claims (e.g., "Over 18", "Accredited Investor", "University Graduate"). These attestations are cryptographically linked to the user's identity chain and signed with the attester's key.
...
- The same attestation pattern gives AI agents verifiable, signed provenance for their actions — see [Agent Audit Trails](/docs/v4.0.0/dev-tools/agent-audit-trails).
...
- This attestation is recorded in the attester's Aqua chain.
...
- [SDK Core](/docs/v4.0.0/dev-tools/sdk-core) - Tools for issuing and verifying claims.
