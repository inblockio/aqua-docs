...
An Ed25519 signature revision from the SDK's seed corpus ([`src/tests/seed/sign_did_example.aqua.json`](https://github.com/inblockio/aqua-rs-sdk-core/blob/main/src/tests/seed/sign_did_example.aqua.json)). Its target is a genesis anchor revision — the same tree appears as the worked example on the [Anchors & Links](/docs/v4.0.0/schema-reference/anchors-and-links) page:
...
- [Hashing & Canonicalization](/docs/v4.0.0/schema-reference/hashing) — how revision hashes and multihashes are computed
...
- [Anchors & Links](/docs/v4.0.0/schema-reference/anchors-and-links) — the branch revision kind that carries links instead of signatures
