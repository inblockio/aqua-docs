...
description: 'Complete guide for developing with Aqua Protocol'
icon: "code"
---
...
<Note>
**Prerequisites**: We recommend completing the [Quick Start Guide](/quickstart) before diving into development details.
</Note>
...
<CardGroup cols={2}>
  <Card title="Rust SDK (v4)" icon="rust" href="/dev_tools/aqua_sdk">
    **Beta** - Template system, WASM support, cross-platform

    Best for: New projects, performance-critical applications
  </Card>

  <Card title="JavaScript SDK (v3)" icon="js" href="/previous_versions/version_3/tooling">
...
<Warning>
**Security**: Never commit credentials.json to version control! Add it to `.gitignore`.
</Warning>
...
<Warning>
**Security**: Your Nostr secret key is permanent. Anyone with it can post as you on Nostr relays. Keep it secure!
</Warning>
...
<CardGroup cols={2}>
  <Card title="Rust SDK Guide" icon="rust" href="/dev_tools/aqua_sdk">
...
<CardGroup cols={2}>
  ...
  <Card title="Get Support" icon="life-ring" href="mailto:info@inblock.io">
